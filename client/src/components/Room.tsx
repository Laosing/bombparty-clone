...
export function Room() {
  ...
  // @ts-ignore - roomId is added to context in InitializeRoom but not in types yet, or we need to check how it is passed
  // Checking InitializeRoom later. For now assuming room context might have it or we get it from elsewhere.
  // Actually usually roomId comes from URL params in React Router but here it seems provided by context.
  const { roomId, room } = useRoom() as any // Temporary cast until I fix RoomContext type
